...
import com.dev.cs_api.identity.dtos.admin.AdminSecurityProfileResponse;
...
import com.dev.cs_api.identity.dtos.user.UserSecurityProfileResponse;
...
public class ProfileService {
    ...
    public com.dev.cs_api.identity.dtos.global.ProfileResponse findProfile() {
        User user = findUser();
